...
public class ActivityUserActionDatasource extends UserActionDatasource {
  public static final String DATASOURCE_TAG = "activity_datasource";

  public static final String COUNTRY_COLUMN_TAG =
      RegistrationUserActionDatasource.COUNTRY_COLUMN_TAG;
  public static final String PLATFORM_COLUMN_TAG =
      RegistrationUserActionDatasource.PLATFORM_COLUMN_TAG;
  public static final String BUILD_VERSION_COLUMN_TAG =
      RegistrationUserActionDatasource.BUILD_VERSION_COLUMN_TAG;
  ...
  public ActivityUserActionDatasource(String id, String label, Optional<String> description,
